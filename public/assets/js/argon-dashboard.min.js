...
function darkMode(e) {
  const t = document.getElementsByTagName("body")[0],
    ...
    o = document.querySelectorAll("span.text-dark"),
  ...
  if (e.getAttribute("checked")) {
    ...
    for (A = 0; A < k.length; A++)
      k[A].classList.contains("text-dark") &&
        (k[A].classList.add("text-dark"), k[A].classList.remove("text-dark"));
    for (A = 0; A < S.length; A++)
      S[A].classList.contains("text-dark") &&
        (S[A].classList.remove("text-dark"), S[A].classList.add("text-dark"));
    ...
    for (var A = 0; A < r.length; A++)
      r[A].classList.contains("text-dark") &&
        (r[A].classList.remove("text-dark"), r[A].classList.add("text-dark"));
    ...
    for (var A = 0; A < u.length; A++)
      u[A].classList.contains("text-dark") &&
        (u[A].classList.remove("text-dark"), u[A].classList.add("text-dark"));
